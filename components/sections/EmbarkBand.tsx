 ...
 * a full-height Embark photo on the right. Below the copy, three serif
...
export function EmbarkBand({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-[1.15] flex-col justify-between px-10 pb-16 pt-[72px] lg:px-[72px] lg:pr-14">
        <div className="flex flex-col">
          <span className="flex items-center gap-2">
            ...
            <span className="font-sans text-xs font-semibold uppercase tracking-[0.14em] text-[#c8a877]">
              Flagship — Embark {project.vertical}
            </span>
          </span>
          ...
          >
            <span>Six brands.</span>
            <span>One platform.</span>
          </h2>

          <p className="mt-7 max-w-[480px] font-sans text-[17px] leading-[27px] text-[#b7ae9f]">
            A pet-services roll-up that acquired faster than its websites
            could keep up. We built the system that ships every new
            acquisition on one shared Next.js + Sanity platform.
          </p>
        </div>
          ...
          <dl className="flex gap-12">
            {stats.map((s) => (
              <div key={s.label} className="flex flex-col gap-1">
                <dd className="font-serif text-[46px] font-normal leading-none text-[#f7f3ea]">
                  {s.value}
                </dd>
      ...
      {/* Right — full-height Embark photo */}
      <div className="relative min-h-[360px] flex-[0.85] lg:min-h-[560px]">
        <Image
          src={project.image!}
